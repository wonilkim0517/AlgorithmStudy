...
mapWithWalls = []
visited = [[[0] * (K + 2) for _ in range(M)] for _ in range(N)]
for _ in range(N):
    ...
    while q:
        ...
        for i in range(4):
            ...
            if 0 <= nx < N and 0 <= ny < M:
                ...
                # 벽이 있는 곳
                elif not visited[nx][ny][broken + 1] and mapWithWalls[nx][ny] == 1 and broken < K:
                    q.append((nx, ny, broken + 1, distance + 1))
